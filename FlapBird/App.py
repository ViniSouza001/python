import pygame # biblioteca de jogos para ser utilizada com a linguagem python
import os # usar os arquivos do próprio computador
...
class Passaro:
    ...
    # identificar a colisão entre o pássaro e o cano
    def get_mask(self):
...
def desenhar_tela(tela, passaros, canos, chao, pontos):
    ...
    pygame.display.update() # desenha a tela do jogo
...
def main():
    ...
    while rodando:
        ...
        for evento in pygame.event.get():
            if evento.type == pygame.QUIT: # se o usuário clicar no X para fechar o jogo
                rodando = False
                pygame.quit()
                quit()

            if evento.type == pygame.KEYDOWN: # se o usuário clicar em alguma tecla
                if evento.key == pygame.K_SPACE: # se a tecla clicada for a barra de espaço
                    for passaro in passaros:
                        passaro.pular()
